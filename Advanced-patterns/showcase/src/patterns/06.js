...
const MediumClap = () => {
    ...
    // as soon as this component mounts the animation, this is not going to work,
    // every single time count is updated after that, which is  exactly when the users claps, we go ahead and call the animation
    useEffectAfterMount(() => {
